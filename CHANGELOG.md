...
- **Watermark detector no longer false-positives on real photos.** The
  ...
  ([#223](https://github.com/9oll/nukebg/pull/223)).
- **Disconnected real subject parts no longer get dropped as orphan
  ...
  ([#224](https://github.com/9oll/nukebg/pull/224)).
- **Sparkle inpaint mask covers the natural halo again.** Follow-up to
  ...
  ([#225](https://github.com/9oll/nukebg/pull/225)).
- **e2e \`coche-capture\` no longer flakes on CI cold-start.** Renamed
  ...
  ([#222](https://github.com/9oll/nukebg/pull/222), closes
  [#160](https://github.com/9oll/nukebg/issues/160)).
...
- **Cross-component custom events now go through a typed event-bus.**
  ...
  at runtime ([#220](https://github.com/9oll/nukebg/pull/220),
  [#221](https://github.com/9oll/nukebg/pull/221), closes
  [#217](https://github.com/9oll/nukebg/issues/217) and the
  outstanding Phase 4 of [#47](https://github.com/9oll/nukebg/issues/47)).
...
- Known limitation tracked in
  [#226](https://github.com/9oll/nukebg/issues/226): RMBG-1.4
...
- **`ar-post-cta` module no longer ships in the bundle.** The element
  ...
  - the matching element in `index.html`); both sites carry inline
    pointers to [#181](https://github.com/9oll/nukebg/issues/181)
    ([#216](https://github.com/9oll/nukebg/pull/216),
    [#196](https://github.com/9oll/nukebg/issues/196)).
...
- **Unit coverage for `watermark-dalle` and `inpaint-telea`.** Both CV
  ...
  ([#215](https://github.com/9oll/nukebg/pull/215),
  [#195](https://github.com/9oll/nukebg/issues/195)).
...
- All audit-driven backlog from the 2026-04-28 cycle is now closed
  ...
  with Phase 4 (typed EventBus) spun out into [#217](https://github.com/9oll/nukebg/issues/217).
...
- **Amber theme — tertiary text on black is readable again.** Previous
  ...
  ([#197](https://github.com/9oll/nukebg/pull/197),
  [#185](https://github.com/9oll/nukebg/issues/185)).
- **Keyboard focus is visible inside the editor again.** Three
  ...
  ([#206](https://github.com/9oll/nukebg/pull/206),
  [#186](https://github.com/9oll/nukebg/issues/186)).
- **WebP magic-byte sniff also validates the RIFF size field.** Polyglot
  ...
  ([#208](https://github.com/9oll/nukebg/pull/208),
  [#189](https://github.com/9oll/nukebg/issues/189)).
- **Reactor page tolerates a malformed `donors.json`.** `ar-reactor.ts`
  ...
  ([#205](https://github.com/9oll/nukebg/pull/205),
  [#188](https://github.com/9oll/nukebg/issues/188)).
- **Reactor methodology section drops the pre-emptive contact line.**
  ...
  ([#184](https://github.com/9oll/nukebg/pull/184)).
- **Capability detector reports a consistent tier across devices.** The
  ...
  ([709d254](https://github.com/9oll/nukebg/commit/709d254)).
...
- **Pruned 19 dead i18n keys across all 6 locales — bundle index.js
  ...
  ([#211](https://github.com/9oll/nukebg/pull/211),
  [#193](https://github.com/9oll/nukebg/issues/193)).
- **Pipeline pixel writes are explicitly clamped.** New
  ...
  ([#209](https://github.com/9oll/nukebg/pull/209),
  [#194](https://github.com/9oll/nukebg/issues/194)).
- **Internal architecture: monolith components split into pure
  ...
  - Batch queue → `src/controllers/batch-orchestrator.ts` (talks to
    ...
    ([#198](https://github.com/9oll/nukebg/pull/198))
  - PWA install button + guide → `src/controllers/app-install.ts`
    ...
    ([#199](https://github.com/9oll/nukebg/pull/199))
...
- **Worker `e.origin` guard at every postMessage entry.** All five
  ...
  ([#204](https://github.com/9oll/nukebg/pull/204),
  [#187](https://github.com/9oll/nukebg/issues/187)).
- **Dependabot patch + minor PRs auto-merge once CI is green.** New
  ...
  ([#207](https://github.com/9oll/nukebg/pull/207),
  [#191](https://github.com/9oll/nukebg/issues/191)).
- **OSV-Scanner job alongside `npm audit` + CodeQL.** Cross-references
  ...
  ([#210](https://github.com/9oll/nukebg/pull/210),
  [#192](https://github.com/9oll/nukebg/issues/192)).
...
- **Post-process CTA disabled** (`<ar-post-cta>`). Current
  ...
  [#181](https://github.com/9oll/nukebg/issues/181)
...
- **`/reactor` rendered inline on the home page**. `<ar-reactor>` ignored its
  ...
  ([#167](https://github.com/9oll/nukebg/pull/167))
- **`/#reactor` rendered hard-left** instead of in the centered 960 px
  ...
  ([#172](https://github.com/9oll/nukebg/pull/172))
- **Footer rendered the literal string `footer.reactorStatus`** instead
  ...
  ([#168](https://github.com/9oll/nukebg/pull/168))
- **Cloudflare Pages deploys failed** when github.com Releases
  ...
  ([#169](https://github.com/9oll/nukebg/pull/169))
...
- **Footer link to `/reactor`**. Replaced the footer's "☕ Tip the
  ...
  transparency page.
  ([#170](https://github.com/9oll/nukebg/pull/170))
...
- **Behavioural test coverage for the 7 untested web components**
  ...
  ([#166](https://github.com/9oll/nukebg/pull/166))
...
- **`/reactor` transparency page** — public sunk-cost + forward-burn breakdown
  ...
  ([#137](https://github.com/9oll/nukebg/pull/137),
  [#138](https://github.com/9oll/nukebg/pull/138),
  [#139](https://github.com/9oll/nukebg/pull/139),
  [#140](https://github.com/9oll/nukebg/pull/140),
  [#141](https://github.com/9oll/nukebg/pull/141))
...
- **Manual remove-watermark lasso action** — distinct from erase-object: uses
  ...
  ([#152](https://github.com/9oll/nukebg/pull/152))
- **SHA-256 supply-chain verification for RMBG-1.4 + MobileSAM** — both models
  ...
  ([#132](https://github.com/9oll/nukebg/pull/132))
- **Contributor licensing terms (CLA)** alongside MobileSAM + LaMa license
  documentation in repo. ([#130](https://github.com/9oll/nukebg/pull/130))
...
- **Quiet mode toggle** — redundant after the Reactor pivot. The motion /
  ...
  ([#148](https://github.com/9oll/nukebg/pull/148))
...
- **Mobile hero `$` glyph duplication** — the short-form hero was rendering
  ...
  prompt. ([#155](https://github.com/9oll/nukebg/pull/155))
...
- **Theme picker grew to six palettes** — original four (terminal-green / amber
  ...
  ([#119](https://github.com/9oll/nukebg/pull/119))
- **Reprocess button in the advanced editor** — re-runs RMBG-1.4 on whatever
  ...
  ([#120](https://github.com/9oll/nukebg/pull/120))
- **Theme switcher in the footer** — four palettes (terminal-green / amber /
  ...
  ([#115](https://github.com/9oll/nukebg/pull/115))
- **In-dropzone model progress** — first-run progress relocated INTO the
  ...
  `dropzone.setLoadingState(...)` API. ([#114](https://github.com/9oll/nukebg/pull/114))
- **Reactor offline → active** in the [STATUS] line — only flips green after
  preload resolves. Dot + word dim while idle.
  ([#114](https://github.com/9oll/nukebg/pull/114))
...
- **Global keyboard shortcuts + `?` hint overlay** — press `/` to focus the
  ...
  shadow tree via a light-DOM overlay. ([#101](https://github.com/9oll/nukebg/pull/101))
...
focus-existing` reuses the open tab; `?help=1` / `?action=new` query params
  ...
  ([#102](https://github.com/9oll/nukebg/pull/102))
...
- **Restore-original drops its confirm bar** — `pushUndo()` already snapshots
  ...
  removed. ([#120](https://github.com/9oll/nukebg/pull/120))
- **Pipeline pinned to `'high-power'`** — the segmentation pipeline now always
  ...
  ([#113](https://github.com/9oll/nukebg/pull/113))
...
- **Polish pass** — typography tokens collapsed to 12/14/16, progress bar
  ...
  ([#87](https://github.com/9oll/nukebg/pull/87))
...
- **Editor canvases are tabbable + described** — `tabindex="0"`, `role="img"`,
  ...
  ([#107](https://github.com/9oll/nukebg/pull/107))
...
- **Reduced-motion audit** across every component that ships `@keyframes`;
  ...
  mode. ([#100](https://github.com/9oll/nukebg/pull/100))
- **Escape closes the shortcuts popover** ([#62](https://github.com/9oll/nukebg/pull/62)).

### Infrastructure

- **Runtime hardening** — tokens, size limits, caps, engine pins, HEALTHCHECK.
  ([#66](https://github.com/9oll/nukebg/pull/66))
- **Production sourcemaps disabled**
  ([#51](https://github.com/9oll/nukebg/pull/51)).
...
- **RTL scaffolding** — `getDirection(locale)` helper + auto-flip of
  ...
  ([#109](https://github.com/9oll/nukebg/pull/109))
...
- **`exploration/` promoted to `src/refine/`** — what was lab-tagged code has
  ...
  behaviour change. ([#119](https://github.com/9oll/nukebg/pull/119))
...
[Unreleased]: https://github.com/9oll/nukebg/compare/v2.11.2...dev
[2.11.2]: https://github.com/9oll/nukebg/compare/v2.11.1...v2.11.2
[2.11.1]: https://github.com/9oll/nukebg/compare/v2.11.0...v2.11.1
